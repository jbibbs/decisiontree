...
// In this case, 1's are yes answers and 2's are no's.
	public static $nodes = array(
		...
		array('id' => 23, 'next' => 'results', 'path' => '1.1.1.0.1'),
		array('id' => 24, 'next' => 'results', 'path' => '1.1.1.0.0'),
		array('id' => 25, 'next' => 7,         'path' => '1.1.0.1.1.1'),
		array('id' => 26, 'next' => 'results', 'path' => '1.1.0.1.1.0'),
		array('id' => 27, 'next' => 7,         'path' => '1.1.0.1.1.0'),
		array('id' => 28, 'next' => 'results', 'path' => '1.1.0.1.1.1.1'),
		array('id' => 29, 'next' => 'results', 'path' => '1.1.0.1.1.1.0'),
