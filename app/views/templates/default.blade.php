...
<body>
  ...
  <header>
    ...
    <div id="headlow">
        <div class="container">
          <p class="upper">No one leadership style or decision making process fits all situations. By analyzing the situation and evaluating the problem based on time, team buy-in, and decision quality, a conclusion about which style best fits the situation can be made. This model defines a very logical approach to which style to adopt when trying to balance the benefits of participative management with the need to make decisions effectively.</p>
